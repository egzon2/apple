            ...
            <div class="container flex space-evenly">
                <div class="containeri">
                    <form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  method="POST" onsubmit="return validimi()">
                        ...
                        <input type="checkbox" name="technology[]" value="Smartphones"> Smartphones<br/>
                        <input type="checkbox" name="technology[]" value="Watches"> Watches<br/>
                        <input type="checkbox" name="technology[]" value="Macbook" > Macbook<br/>
                        <input type="checkbox" name="technology[]" value="Tablet"> Tablet<br/>
                        <input type="checkbox" name="technology[]" value="Airpods" > Airpods<br/><br/>
